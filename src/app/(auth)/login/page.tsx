    ...
    <div className="min-h-screen bg-[#0f0f1a] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="font-display font-bold text-2xl text-white mt-6 mb-2">Welcome back</h1>
        ...
        <div className="glass-card p-8">
          {/* Google OAuth */}
          <button
            className="btn-ghost w-full justify-center mb-6 gap-3"
            onClick={() => toast.info("Google sign-in coming soon! Please use email for now.")}
          >
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-slate-500 text-sm focus:outline-none focus:border-indigo-500/60 focus:bg-white/8 transition-all"
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-slate-500 text-sm focus:outline-none focus:border-indigo-500/60 focus:bg-white/8 transition-all pr-12"
                />
                <button
                  type="button"
